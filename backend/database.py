"""
Mock Database for Laptop Recommendation System (Prices in Indian Rupees - ₹ / Rs.)
Includes Student Benefits, Education Discounts, UNiDAYS Perks, Pros/Cons, Ratings, Power Score (/10), Certifications, Benchmarks, and Heating/Cooling Specs.
"""
...
MOCK_LAPTOPS = [
    {
        ...
        "priceHistory": [
            {"date": "2026-05-01", "price": 184999},
            {"date": "2026-06-01", "price": 174999},
            {"date": "2026-07-01", "price": 164999},
            {"date": "2026-08-01", "price": 154999},
            {"date": "2026-09-01", "price": 144999, "predicted": True}
        ],
        "prediction": {
            "trend": "dropping",
    ...
    },
    {
        ...
        "priceHistory": [
            {"date": "2026-05-01", "price": 169900},
            {"date": "2026-06-01", "price": 159900},
            {"date": "2026-07-01", "price": 154900},
            {"date": "2026-08-01", "price": 149990},
            {"date": "2026-09-01", "price": 144900, "predicted": True}
        ],
        "prediction": {
            "trend": "dropping",
    ...
    },
    {
        ...
        "priceHistory": [
            {"date": "2026-05-01", "price": 134990},
            {"date": "2026-06-01", "price": 124990},
            {"date": "2026-07-01", "price": 114990},
            {"date": "2026-08-01", "price": 109990},
            {"date": "2026-09-01", "price": 99990, "predicted": True}
        ],
        "prediction": {
            "trend": "dropping",
    ...
    },
    {
        ...
        "priceHistory": [
            {"date": "2026-05-01", "price": 109900},
            {"date": "2026-06-01", "price": 99900},
            {"date": "2026-07-01", "price": 94990},
            {"date": "2026-08-01", "price": 89990},
            {"date": "2026-09-01", "price": 84990, "predicted": True}
        ],
        "prediction": {
            "trend": "dropping",
    ...
    },
    {
        ...
        "priceHistory": [
            {"date": "2026-05-01", "price": 74990},
            {"date": "2026-06-01", "price": 68990},
            {"date": "2026-07-01", "price": 62990},
            {"date": "2026-08-01", "price": 58990},
            {"date": "2026-09-01", "price": 55990, "predicted": True}
        ],
        "prediction": {
            "trend": "dropping",
    ...
    },
    {
        ...
        "priceHistory": [
            {"date": "2026-05-01", "price": 169990},
            {"date": "2026-06-01", "price": 159990},
            {"date": "2026-07-01", "price": 149990},
            {"date": "2026-08-01", "price": 142990},
            {"date": "2026-09-01", "price": 142990, "predicted": True}
        ],
        "prediction": {
            "trend": "stable",
    ...
    },
    {
        ...
        "priceHistory": [
            {"date": "2026-05-01", "price": 309990},
            {"date": "2026-06-01", "price": 289990},
            {"date": "2026-07-01", "price": 274990},
            {"date": "2026-08-01", "price": 259990},
            {"date": "2026-09-01", "price": 249990, "predicted": True}
        ],
        "prediction": {
            "trend": "dropping",
